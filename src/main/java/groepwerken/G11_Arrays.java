    ...
    public static void main(String[] args) {
        ...
        double sayilar[] = {12, 5, 8, 7, 4, 1, 10, 21};
            ...
            if ((sayilar.length)%2==0){
                ...
                System.out.println("1.soru" + sayilar[sayi2]);
...
//BUNA BAK
       ...
       9) Verilen bir String arraydeki belirli bir öğenin var olup olmadığını bulmak için kod yazınız.
        ...
        String rrr[] = {"Kemal", "Jonathan", "Mark", "Angie", "Veli"};
        int top1 = 0;
        ...
        System.out.println( "10. sorunun cevabi " + top1);
        ...
        String st1 = input.nextLine().toLowerCase();
        System.out.println("bir string daha giriniz");
        String st2 = input.nextLine().toLowerCase();

        String sta[] = st1.split(" ");
        String sta2[] = st2.split(" ");

        if (sta.length!=sta2.length){
